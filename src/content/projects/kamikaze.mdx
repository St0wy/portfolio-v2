...
We first created a (not so good) [**Game Design Document**](/kamikaze/GDD_Kamikaze.pdf) (GDD) outlining the **game's progression** and various **troops and enemy types**.
...
The initial **presentation** of this document to our teacher **didn't go well** as the fun factor was unclear.

However, we received good **feedback** to incorporate **synergies between troops**, leading us to introduce an ice troop that freezes enemies and increases damage, as well as an enemy vulnerable only when frozen.
